...
static char capture_file_name[100] = "capture.yuv\0";
...
/*
static void yuv422_to_rgb(const unsigned char *yuv, int width, int height);
{
    int i,j;
    short Y;
    unsigned char *rgb;
...
{
    capture_fp = fopen(capture_file_name, "wa+");
